...
//				l_randomEnemyCountry = l_randomEnemyCountry == 0 ? 1 : l_randomEnemyCountry;
				if(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNumberOfArmiesPresent() <= 1) {
					l_randomArmies = d_gameEngine.d_random.nextInt(1);
				}
				else {
					l_randomArmies = d_gameEngine.d_random.nextInt(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNumberOfArmiesPresent()-1);	
				}
//				l_randomArmies = d_gameEngine.d_random.nextInt(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNumberOfArmiesPresent());
				l_order = new Advance(d_player, l_playerCountries.get(l_randomOwnCountry), l_neighborCountries.get(l_randomEnemyCountry), l_randomArmies);
				System.out.println("Attack from: " + l_playerCountries.get(l_randomOwnCountry) + ", to:  " + l_neighborCountries.get(l_randomEnemyCountry) + ", armies: " + l_randomArmies);
				d_gameEngine.d_logEntryBuffer.setString("Attack from: " + l_playerCountries.get(l_randomOwnCountry) + ", to:  " + l_neighborCountries.get(l_randomEnemyCountry) + ", armies: " + l_randomArmies);
				break;
...
//				System.out.println();
				System.out.println("MOVE: " + d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getId());
				int l_randomNeighbor = d_gameEngine.d_random.nextInt(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNeighborCountries().size());
				int l_randomNeighborId = new ArrayList<>(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNeighborIds()).get(l_randomNeighbor);
				if(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNumberOfArmiesPresent() == 0) {
					l_randomArmies = d_gameEngine.d_random.nextInt(1);
				}
				else {
					l_randomArmies = d_gameEngine.d_random.nextInt(d_gameEngine.getGameMap().getCountries().get(l_playerCountries.get(l_randomOwnCountry)).getNumberOfArmiesPresent());	
