...
/**
 * abstract class that is implemented by concrete strategy classes This is the
 * class that declares the method to be implemented by the various strategies.
 */
public abstract class PlayerStrategy {
	...
	/**
	 * constructor method for PlaerStrategy taking the name of he player and game
	 * engine object
	 * 
