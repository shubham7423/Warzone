...
/**
 * Abstract class of game setup the represents the initial process of enetering the gameplay 
 */
public abstract class GameSetup extends GamePhase {

	/**
	 * constructor method of the class that takes game engine object from the parent class  
