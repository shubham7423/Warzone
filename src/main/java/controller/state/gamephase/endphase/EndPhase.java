...
/**
 * This is the class that inherits GamePhase class whose fucntion is to print the winner of the game
 */
public class EndPhase extends GamePhase {
	...
	/**
	 * function to proceed to the next phase of the game but as this is the final phase of the game this function does not execute
	 */
	@Override
	public void next() {
	...
	/**
	 * function to print invalid command as the following command cannot be used in this phas
	 * @return string to print the invalid command message
	 */
	@Override
